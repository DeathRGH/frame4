...
int sys_open_hook(struct thread *td, struct syscall_open *args) { // this entire hook must NOT be rip dependent
    ...
    uint8_t *ptr_kernel = (uint8_t *)((((uint64_t)edx) << 32) | (uint64_t)eax) - __Xfast_syscall;

    struct hook_data *data = (struct hook_data *)(*(uint64_t *)ptr_kernel);
    ...
    switch (data->cachedFw) {
        case 505:
            _printf = (void *)&ptr_kernel[0x436040];
            _strlen = (void *)&ptr_kernel[0x3B71A0];
            _strcpy = (void *)&ptr_kernel[0x8F250];
            _strncmp = (void *)&ptr_kernel[0x1B8FE0];
            _sys_stat = (void *)&ptr_kernel[0x33DFE0];
            original_call = (void *)&ptr_kernel[0x33B990];
            break;
        case 672:
            _printf = (void *)&ptr_kernel[0x123280];
            _strlen = (void *)&ptr_kernel[0x2433E0];
            _strcpy = (void *)&ptr_kernel[0x2390C0];
            _strncmp = (void *)&ptr_kernel[0x39B6E0];
            _sys_stat = (void *)&ptr_kernel[0x4A0F30];
            original_call = (void *)&ptr_kernel[0x49E970];
            break;
        case 702:
            _printf = (void *)&ptr_kernel[0xBC730];
            _strlen = (void *)&ptr_kernel[0x93FF0];
            _strcpy = (void *)&ptr_kernel[0x2CC70];
            _strncmp = (void *)&ptr_kernel[0x3DABE0];
            _sys_stat = (void *)&ptr_kernel[0x357F20];
            original_call = (void *)&ptr_kernel[0x355940];
            break;
        case 900:
            _printf = (void *)&ptr_kernel[0xB7A30];
            _strlen = (void *)&ptr_kernel[0x30F450];
            _strcpy = (void *)&ptr_kernel[0x189F80];
            _strncmp = (void *)&ptr_kernel[0x124750];
            _sys_stat = (void *)&ptr_kernel[0x1DC4F0];
            original_call = (void *)&ptr_kernel[0x1D9EC0];
            break;
        case 1100:
            _printf = (void *)&ptr_kernel[0x2FCBD0];
            _strlen = (void *)&ptr_kernel[0x21DC40];
            _strcpy = (void *)&ptr_kernel[0x1AA590];
            _strncmp = (void *)&ptr_kernel[0x313B10];
            _sys_stat = (void *)&ptr_kernel[0xE8960];
            original_call = (void *)&ptr_kernel[0xE6330];
            break;
        default:
            break;
    }
    ...
    //if (cred->cr_uid == 1)
    //if (!_strncmp(cached_firmware == 505 ? castedProc->titleid : td->td_proc->titleid, data->cusa, 4))
        //_printf(data->print_debug1, cred->cr_uid, cached_firmware == 505 ? castedProc->titleid : td->td_proc->titleid, args->path, ret);
    
    if (cred->cr_uid == 0 || _strncmp(cached_firmware == 505 ? castedProc->titleid : td->td_proc->titleid, data->cusa, 4) != 0) {
        goto original;
    }

    _strcpy(possible_path, data->data_path);
    _strcpy(possible_path + _strlen(possible_path), cached_firmware == 505 ? castedProc->titleid : td->td_proc->titleid);
...
int sys_openat_hook(struct thread *td, struct syscall_openat *args) { // this entire hook must NOT be rip dependent
    ...
    switch (data->cachedFw) {
        case 505:
            ...
            _strncmp = (void *)&ptr_kernel[0x1B8FE0];
            _sys_stat = (void *)&ptr_kernel[0x33DFE0];
            original_call = (void *)&ptr_kernel[0x33B9D0];
            break;
        case 672:
            _printf = (void *)&ptr_kernel[0x123280];
            _strlen = (void *)&ptr_kernel[0x2433E0];
            ...
            _strncmp = (void *)&ptr_kernel[0x39B6E0];
            _sys_stat = (void *)&ptr_kernel[0x4A0F30];
            original_call = (void *)&ptr_kernel[0x49E9B0];
            break;
        case 702:
            _printf = (void *)&ptr_kernel[0xBC730];
            _strlen = (void *)&ptr_kernel[0x93FF0];
            ...
            _strncmp = (void *)&ptr_kernel[0x3DABE0];
            _sys_stat = (void *)&ptr_kernel[0x357F20];
            original_call = (void *)&ptr_kernel[0x355980];
            break;
        case 900:
            _printf = (void *)&ptr_kernel[0xB7A30];
            _strlen = (void *)&ptr_kernel[0x30F450];
            ...
            _strncmp = (void *)&ptr_kernel[0x124750];
            _sys_stat = (void *)&ptr_kernel[0x1DC4F0];
            original_call = (void *)&ptr_kernel[0x1D9F00];
            break;
        case 1100:
            _printf = (void *)&ptr_kernel[0x2FCBD0];
            _strlen = (void *)&ptr_kernel[0x21DC40];
            ...
            _strncmp = (void *)&ptr_kernel[0x313B10];
            _sys_stat = (void *)&ptr_kernel[0xE8960];
            original_call = (void *)&ptr_kernel[0xE6370];
            break;
        default:
            break;
    }
    ...
    if (cred->cr_uid == 1) {
        //if (!_strncmp(cached_firmware == 505 ? castedProc->titleid : td->td_proc->titleid, data->cusa, 4))
        _printf(data->print_debug1, cred->cr_uid, cached_firmware == 505 ? castedProc->titleid : td->td_proc->titleid, args->path, 11111111);
    }
...
int install_afr_hooks() {
    ...
    cpu_disable_wp();
    *(uint64_t *)cached_kernel_base = (uint64_t)data;
